...
const sections = [
	{
		title: 'Введение',
		description:
			'Знакомство с основами Vue 3, установка CLI и первые компоненты.',
		items: [
			{ id: 201, title: 'Установка и настройка проекта', completed: false },
			{ id: 202, title: 'Первая компонента', completed: false },
		],
	},
	{
		title: 'Композиционный API',
		description: 'Работа с setup(), реактивностью и lifecycle hooks.',
		items: [
			{ id: 211, title: 'reactive и ref', completed: false },
			{ id: 212, title: 'watch и computed', completed: false },
		],
	},
]

// статические слоты расписания
const uniqueDates = ['2025-05-20', '2025-05-21', '2025-05-22']
	...
	'2025-05-20': [
		{
			...
			start_time: '10:00',
			end_time: '10:15',
			appointments: [{ position: 1, first_name: 'Анна', last_name: 'Иванова' }],
			max_slots: 4,
		},
	],
	'2025-05-21': [
	...
	'2025-05-22': [
		{
			...
			start_time: '12:00',
			end_time: '12:15',
			appointments: [{ position: 1, first_name: 'Пётр', last_name: 'Сидоров' }],
			max_slots: 4,
		},
	],
}

const sect = ref('course')
...
<template>
	<div class="max-w-7xl mx-auto py-6 space-y-6">
		<!-- Карточка курса -->
		<CourseItemMain
			class="md:col-span-2 md:row-span-2 mb-6 block"
			:id="course.id"
			:slug="course.slug"
			:img="course.img"
			:title="course.title"
		...
		<nav class="border-b border-gray-200">
			<ul class="flex -mb-px">
				<li
					@click="sect = 'course'"
					class="text-gray-600 mr-4 hover:text-gray-800 border-b-2 pb-2 cursor-pointer"
					:class="{ 'border-blue-600  text-blue-600': sect === 'course' }"
				>
					Курс
				</li>
				<li
					@click="sect = 'schedule'"
					class="text-gray-600 hover:text-gray-800 border-b-2 pb-2 cursor-pointer"
					:class="{ 'border-blue-600 text-blue-600': sect === 'schedule' }"
				>
